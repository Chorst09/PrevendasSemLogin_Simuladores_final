                                            ...
                                            <TableCell>
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        // Flag Parceiro Indicador
                                                        // @ts-expect-error campo pode não existir em propostas antigas
                                                        setHasPartnerIndicator(!!(proposal as any).partnerIndicator);
                                                        setCurrentView('calculator');
                                                    }}
                                                >
                                                    Editar
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                        ...
                        <Card className="bg-slate-900/80 border-slate-800 text-white">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                {pabxIncludeAI && (
                                    <div>
                                        <Label htmlFor="contract-period">Período do Contrato (meses)</Label>
